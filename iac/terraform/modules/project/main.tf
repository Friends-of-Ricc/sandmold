...
resource "google_project" "new" {
  ...
  folder_id          = var.parent != null ? (substr(var.parent, 0, 8) == "folders/" ? split("/", var.parent)[1] : null) : null
  org_id             = var.parent != null ? (substr(var.parent, 0, 13) == "organizations/" ? split("/", var.parent)[1] : null) : null
  labels             = var.labels
