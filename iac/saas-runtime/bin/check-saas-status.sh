...
gcloud beta saas-runtime units list     --filter="unitKind=projects/${GOOGLE_CLOUD_PROJECT}/locations/global/unitKinds/${UNIT_KIND_GLOBAL}"     --location=global     --project="${GOOGLE_CLOUD_PROJECT}"     --format="value(name,unitKind,state)" || true

# List units for the regional Unit Kind
gcloud beta saas-runtime units list     --filter="unitKind=projects/${GOOGLE_CLOUD_PROJECT}/locations/${GOOGLE_CLOUD_REGION}/unitKinds/${UNIT_KIND_REGIONAL}"     --location="${GOOGLE_CLOUD_REGION}"     --project="${GOOGLE_CLOUD_PROJECT}"     --format="value(name,unitKind,state)" || true
